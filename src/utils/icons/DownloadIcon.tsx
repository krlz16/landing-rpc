...
function DonwloadIcon({ className }: { className?: string}) {
  return (
    <svg className={className} width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
